...
template ProfitRegex(msg_bytes) {
	...
	component and[70][num_bytes];
	component multi_or[6][num_bytes];
	signal states[num_bytes+1][66];
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		and[37][i].b <== multi_or[2][i].out;
		and[38][i] = AND();
		and[38][i].a <== states[i][36];
		and[38][i].b <== multi_or[2][i].out;
		multi_or[3][i] = MultiOR(2);
		multi_or[3][i].in[0] <== and[37][i].out;
		multi_or[3][i].in[1] <== and[38][i].out;
		states[i+1][36] <== multi_or[3][i].out;
		...
		and[45][i].b <== eq[20][i].out;
		states[i+1][43] <== and[45][i].out;
		state_changed[i].in[42] <== states[i+1][43];
		and[46][i] = AND();
		and[46][i].a <== states[i][43];
		and[46][i].b <== and[0][i].out;
		and[47][i] = AND();
		and[47][i].a <== states[i][44];
		and[47][i].b <== and[0][i].out;
		multi_or[4][i] = MultiOR(2);
		multi_or[4][i].in[0] <== and[46][i].out;
		multi_or[4][i].in[1] <== and[47][i].out;
		states[i+1][44] <== multi_or[4][i].out;
		state_changed[i].in[43] <== states[i+1][44];
		and[48][i] = AND();
		and[48][i].a <== states[i][38];
		and[48][i].b <== eq[16][i].out;
	...
	for (var i = 0; i <= num_bytes; i++) {
		final_state_result.in[i] <== states[i][63];
	}
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_consecutive[msg_bytes-1-i][0] <== states[num_bytes-i][63] * (1 - is_consecutive[msg_bytes-i][1]) + is_consecutive[msg_bytes-i][1];
		is_consecutive[msg_bytes-1-i][1] <== state_changed[msg_bytes-i].out * is_consecutive[msg_bytes-1-i][0];
	}

	signal is_substr0[msg_bytes][29];
	signal is_reveal0[msg_bytes];
	signal output reveal0[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][3] * states[i+2][4];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][0] * states[i+2][3];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][4] * states[i+2][24];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][24] * states[i+2][38];
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][38] * states[i+2][45];
		is_substr0[i][6] <== is_substr0[i][5] + states[i+1][47] * states[i+2][62];
		is_substr0[i][7] <== is_substr0[i][6] + states[i+1][45] * states[i+2][47];
		is_substr0[i][8] <== is_substr0[i][7] + states[i+1][62] * states[i+2][64];
		is_substr0[i][9] <== is_substr0[i][8] + states[i+1][64] * states[i+2][65];
		is_substr0[i][10] <== is_substr0[i][9] + states[i+1][1] * states[i+2][1];
		is_substr0[i][11] <== is_substr0[i][10] + states[i+1][65] * states[i+2][1];
		is_substr0[i][12] <== is_substr0[i][11] + states[i+1][63] * states[i+2][63];
		is_substr0[i][13] <== is_substr0[i][12] + states[i+1][61] * states[i+2][63];
		is_substr0[i][14] <== is_substr0[i][13] + states[i+1][60] * states[i+2][61];
		is_substr0[i][15] <== is_substr0[i][14] + states[i+1][59] * states[i+2][60];
		is_substr0[i][16] <== is_substr0[i][15] + states[i+1][58] * states[i+2][59];
		is_substr0[i][17] <== is_substr0[i][16] + states[i+1][57] * states[i+2][58];
		is_substr0[i][18] <== is_substr0[i][17] + states[i+1][56] * states[i+2][57];
		is_substr0[i][19] <== is_substr0[i][18] + states[i+1][55] * states[i+2][56];
		is_substr0[i][20] <== is_substr0[i][19] + states[i+1][54] * states[i+2][55];
		is_substr0[i][21] <== is_substr0[i][20] + states[i+1][52] * states[i+2][53];
		is_substr0[i][22] <== is_substr0[i][21] + states[i+1][53] * states[i+2][54];
		is_substr0[i][23] <== is_substr0[i][22] + states[i+1][51] * states[i+2][52];
		is_substr0[i][24] <== is_substr0[i][23] + states[i+1][50] * states[i+2][51];
		is_substr0[i][25] <== is_substr0[i][24] + states[i+1][49] * states[i+2][50];
		is_substr0[i][26] <== is_substr0[i][25] + states[i+1][48] * states[i+2][49];
		is_substr0[i][27] <== is_substr0[i][26] + states[i+1][46] * states[i+2][48];
		is_substr0[i][28] <== is_substr0[i][27] + states[i+1][44] * states[i+2][46];
		is_reveal0[i] <== is_substr0[i][28] * is_consecutive[i][1];
